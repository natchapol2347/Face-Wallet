...
# url = '172.20.10.3' #for other raspberrypi


# def smartsafe():
#
#
#     requests.get('http://'+url+':5000/controller_open').text
# def smartsafeClose ():
#     requests.get('http://'+url+':5000/controller_close').text
#
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Face Wallet",fg="black", font=("controller.title_font", 50, "bold italic"))
#        label.config(font=)
